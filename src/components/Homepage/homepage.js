  ...
  return (
    <section id="intro">
      ...
      <img src={profilePic} alt="Profile" className="backgroundIntroImg" />
        ...
        I'm a recent Engineering graduate from BMS Institute of Technology and Management, I specialize in data analysis and tools like Excel, Python, Power BI, Tableau and MySQL. I am skilled in ReactJS, JavaScript and Media query as am interested in Frontend Development. My hobbies are graphic designing, reading, writing fictions and playing cricket. Let's connect to explore how my analytical and technical expertise can add value to your team.
        </p>
        <Link to="/contact">
