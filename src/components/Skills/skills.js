    ...
    <section id="skills">
      <div className="skillContent">
        ...
        <span className="skillDesc">
          I have a solid background in data analysis and front-end development, complemented by strong expertise in UI/UX design. This allows me to create visually appealing interfaces that are user-friendly,while effectively analyzing and interpreting data.</span>
